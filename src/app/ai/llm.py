...
Опиши его сильную сторону, внутренний конфликт и одну деталь о его друзьях.

Правила:
- Пиши только на русском, без английских слов и латиницы.
- Не выдумывай новые слова — используй только обычные русские слова.
- Не используй имя пользователя в тексте, говори "ты" или просто описывай.
- Сплошной текст в 1-2 абзаца, без списков."""
